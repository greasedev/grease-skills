...
export function createWorkflowApis(agent: Agent): WorkflowApis {
  ...
  /**
   * ListTweets
   * Fetch tweets from a Twitter/X list using network interception with auto-scroll
  ...
  /**
   * ListMembers
   * Get members of a Twitter/X list using network interception with auto-scroll
